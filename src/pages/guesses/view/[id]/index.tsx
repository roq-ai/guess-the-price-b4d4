...
import { getGuessById } from 'apiSdk/guesses';
import { GuessInterface } from 'interfaces/guess';

function GuessViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Guessed Price" text={data?.guessed_price} />

                <FormListItem label="Time Taken" text={data?.time_taken} />
